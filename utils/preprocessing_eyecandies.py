...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='datasets/eyecandies', type=str,
                        help="Original Eyecandies dataset path.")
    ...
    for category_dir in categories_list:
        print('current category: ', category_dir)
        ...
        for i in tqdm(range(0, num_train_files), desc='Train'):
        ...
        for i in tqdm(range(0, num_test_files), desc='Test'):
